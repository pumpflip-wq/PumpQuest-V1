...
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
    ...
    var Game = Class.extend({
        ...
        initAchievements: function() {
            ...
            this.achievements = {
                ...
                AT_WORLDS_END: {
                    ...
                    desc: "Reach the bottom edge of the StoryVerse"
                },
                COWARD: {
                    id: 8,
                    name: "Coward",
        ...
        setSpriteScale: function(scale) {
            ...
            if(!this.spritesets || !this.spritesets[0]) {
                return;
            }
        ...
        connect: function(started_callback) {
            ...
            this.client.onWelcome(function(id, name, x, y, hp) {
                ...
                if(!self.storage.hasAlreadyPlayed()) {
                    ...
                    self.showNotification("Welcome to PumpStory!");
                } else {
                    self.showNotification("Welcome back to PumpStory!");
