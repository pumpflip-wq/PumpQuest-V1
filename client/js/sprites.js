...
define(['text!../sprites/agent.json',
        ...
        'text!../sprites/doge.json',
        'text!../sprites/pepe.json',
        'text!../sprites/wojak.json',
        'text!../sprites/chad.json',
        'text!../sprites/memecoin.json',
        'text!../sprites/normie.json',
        'text!../sprites/paperhands.json',
        'text!../sprites/fudster.json',
        'text!../sprites/shill.json',
        'text!../sprites/ngmi.json',
        'text!../sprites/bagholder.json',
        'text!../sprites/finalmonk.json',
        'text!../sprites/troll.json',
        'text!../sprites/gmhandle.json',
        'text!../sprites/dioptionhandle.json',
        'text!../sprites/diamondhandle.json',
        'text!../sprites/bluehandle.json',
        'text!../sprites/bluehandle2.json',
        'text!../sprites/lambohandle.json',
        'text!../sprites/moonshothandle.json',
        'text!../sprites/item-gmhandle.json',
        'text!../sprites/item-dioptionhandle.json',
        'text!../sprites/item-diamondhandle.json',
        'text!../sprites/item-bluehandle.json',
        'text!../sprites/item-bluehandle2.json',
        'text!../sprites/item-lambohandle.json',
        'text!../sprites/item-moonshothandle.json',
        'text!../sprites/item-energydrink.json',
        'text!../sprites/item-pizza.json',
        'text!../sprites/item-redherring.json',
        'text!../sprites/item-tendies.json',
