            ...
            if(dispatcherMode) {
                this.connection.onmessage = function(e) {
                    ...
                    if(reply.status === 'OK') {
                        ...
                        alert("PumpStory is currently at maximum player population. Please retry later.");
                    } else {
                        alert("Unknown error while connecting to PumpStory.");
                    }
                };
            } else {
                ...
                this.connection.onclose = function() {
                    ...
                    if(self.disconnected_callback) {
                        if(self.isTimeout) {
                            ...
                            self.disconnected_callback("The connection to PumpStory has been lost");
                        }
                    }
                };
            }
